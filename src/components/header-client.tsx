...
export function HeaderClient({ cvFileEs, cvFileEn }: HeaderClientProps) {
    ...
    const cvFile = language === 'es' ? cvFileEs : cvFileEn;
    const cvFileName = language === 'es' ? 'VicenteGomez-CV-ES.pdf' : 'VicenteGomez-CV-EN.pdf';
