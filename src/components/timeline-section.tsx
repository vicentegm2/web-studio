...
export function TimelineSection() {
  ...
  const eventsData = [
    {
      name: t.events.securityCourseVI.name,
      organization: t.events.securityCourseVI.organization,
      date: t.events.securityCourseVI.date,
      description: t.events.securityCourseVI.description,
      url: "https://extension.uned.es/actividad/idactividad/45909",
      images: []
    },
    {
    ...
    {
      name: t.events.securityCourseV.name,
      organization: t.events.securityCourseV.organization,
      date: t.events.securityCourseV.date,
      description: t.events.securityCourseV.description,
